    ...
    <section id='Schedule'>
      <div className="section-container">
        ...
        id="myBtnContainer" className="nav flex flex-row mt-10 items-center justify-center nav-pills mb-3">
          <div className="flex flex-row items-center justify-center day-container transition">
            {days.map((day) => (
              <div key={day} className='day'>
                <button
                
                  className={`btn ${selectedDay === day ? "bg-[#d84cc7] text-white" : ""}`}
          ...
          {scheduleData[selectedDay].map((item, index) => (
            <div key={index} className="  overflow-hidden schedule-box">
              ...
              <div className="p-4 text-center ">
                    <div className='flex justify-center time-box'><p className="text-xs text-gray-500 time ">{item.time}</p></div>
